        ...
        <section id="cta-pricing" class="cta-pricing">
          <div class="container">
            <div class="text-center">
              <h3><strong>Layanan Rawat Inap</strong></h3>
            </div>
          </div>
        </section>
        <br>
        <div class="row">
              ...
              ?>
                <li class="nav-item mb-2">
                  <a class="nav-link <?php echo ($i == 1 ? "active" : "") ?> show" data-bs-toggle="tab" href="#tab-<?php echo $i ?>">
                    <h4><?php echo $row['nama_layanan'] ?></h4>
                  </a>
                </li>
              <?php } ?>
            </ul>
          ...
          <div class="col-lg-7 ml-auto" data-aos="fade-left" data-aos-delay="100">
            <div class="tab-content">
              ...
              "SELECT * FROM layanan_rawat_inap");
              $i = 0;
              while ($row = mysqli_fetch_array($query)) {
              ...
              ?>
                <div class="tab-pane <?php echo ($i == 1 ? "active" : "") ?> show" id="tab-<?php echo $i ?>">
                  <figure>
                    <img src="foto/<?php echo $row['file'] ?>" width="600px" height="400px">
                    <br>
                    <br>
                    <div>
                    ...
                    <?php
                       ...
                       join layanan_fasilitas on fasilitas.fasilitas_id=layanan_fasilitas.fasilitas_id
                       where layanan_id=$layanan_id");
                          while ($row2 = mysqli_fetch_array($query2)) {
                        ?>
                      <li><?php echo $row2['nama_fasilitas']?></li>
                      <?php
                     } 
                     ?>
