    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Layanan igd</H4>
            <form action="layanan_igd_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Nama layanan</p>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="nama_igd">
              </div>
              <p>Upload File</p>
              <div class="form-group mt-3">
                ...
                <table id="example" class="display cell-border" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $row['nama_igd'] ?></td>
                      <td><img src="igd/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                      <td><?php echo $row['deskripsi'] ?></td>
                      <td>
                        <a href="edit_layanan_igd.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-primary">Edit</a>
                        <a href="layanan_igd_act.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                  </tbody>
                <?php } ?>
