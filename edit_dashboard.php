...
$data = mysqli_query($conn, "SELECT * FROM dashboard WHERE dashboard_id = '" . $_GET['id'] . "'");
$kodok = mysqli_fetch_array($data);

$nama = $kodok['nama_dashboard'];
$file = $kodok['file'];
          ...
          <div class="col-lg-10">
            ...
            <form action="input_dashboard_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="nama_dashboard" value="<?php echo $nama ?>">
              </div>
              <p>Upload File</p>
              <div class="form-group mt-3">
              ...
              <div class="form-group mt-3">
                <img src="dashboard/<?php echo $file ?>" width="150px" height="100px">
              </div>
