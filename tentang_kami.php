          ...
          <div class="col-lg-7 ml-auto" data-aos="fade-left" data-aos-delay="100">
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <figure>
                  <h3>VISI</h3>
                  <h6>Sebagai Tempat Terbaik Untuk Proses Penyembuhan Dan Teman Terpercaya Dalam Pelayanan Kesehatan</h6>
                  <br>
                  <h3>MISI</h3>
                  <h6>A. Memberikan pelayanan kesehatan dengan standar kualitas terbaik di wilayah DKI jakarta</h6>
                  <h6>B. Menjadi pusat rujukan bagi layanan Firs Aid perusahaan di wilayah DKI jakarta</h6>
                  <h6>C. Mengembangkan kompetensi SDM dalam hal skill, knowledge, dan attitude di semua lini pelayanan</h6>
                  <h6>D. Memberikan pelayanan kesehatan sesuai dengan kemajuan Teknologi Kedokteran</h6>
                  <h6>E. Memberikan pelayanan kesehatan berbasis Teknologi Informasi yang terinrtegrasi</h6>
              ...
              <div class="tab-pane" id="tab-2">
                <figure>
                  <h5><strong>RS Umum Pekerja</strong></h5>
                  <p>Rumah Sakit Umum Pekerja diresmikan pada tanggal 8 April 2014 oleh Presiden RI Bapak Susilo Bambang
                    Yudhoyono. Rumah Sakit Umum Pekerja merupakan rumah sakit tipe C yang letaknya berada
                    ditengah-tengah lingkungan perusahaan yang dikhususkan untuk para pekerja (buruh) dan masyarakat
                    umum. Rumah Sakit ini berdiri diatas tanah seluas 3.652 m2, luas lantai dasar seluas 1.262 m2 dan
                    luas keseluruhan lantai 8.981 m2 yang terdiri dari 8 lantai dengan kapasitas 173 bed, diantaranya
                    160 bed ruang kamar kelas 2, 10 bed kamar ICU dan 3 bed kamar bersalin.</p>
                </figure>
              </div>
            </div>
          </div>
