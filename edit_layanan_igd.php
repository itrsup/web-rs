...
$data = mysqli_query($conn, "SELECT * FROM layanan_igd WHERE layanan_id = '" . $_GET['id'] . "'");
                    ...
                    <div class="col-lg-10">
                        ...
                        <form action="layanan_igd_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="nama_igd" value="<?php echo $nama ?>">
                            </div>
                            <p>Upload File</p>
                            <div class="form-group mt-3">
                            ...
                            <div class="form-group mt-3">
                                <img src="igd/<?php echo $file ?>" width="150px" height="100px">
                            </div>
                            <p>Deskripsi</p>
                            <div class="form-group mt-3">
