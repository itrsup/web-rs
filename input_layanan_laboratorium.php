    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Layanan laboratorium</H4>
            <form action="layanan_laboratorium_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Nama layanan</p>
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  <thead>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM layanan_laboratorium");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $row['nama_laboratorium'] ?></td>
                      <td><img src="laboratorium/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                      <td><?php echo $row['deskripsi'] ?></td>
                      <td>
                        <a href="edit_layanan_laboratorium.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-primary">Edit</a>
                        <a href="layanan_laboratorium_act.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                  </tbody>
                <?php } ?>
