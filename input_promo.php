    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Promo</H4>
            <form action="input_promo_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Nama Promo</p>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><img src="promo/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                        <td><a href="input_promo_act.php?id=<?php echo $row['promo_id'] ?>" class="btn btn-danger">Hapus</a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
