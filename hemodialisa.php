                ...
                <section id="cta-pricing" class="cta-pricing">
                    <div class="container">
                        <div class="text-center">
                            <h3><strong>Layanan hemodialisa</strong></h3>
                        </div>
                    </div>
                </section>
                <br>
                <div class="row">
                            ...
                            ?>
                                <li class="nav-item mb-2">
                                    <a class="nav-link <?php echo ($i == 1 ? "active" : "") ?> show" data-bs-toggle="tab" href="#tab-<?php echo $i ?>">
                                        <h4><?php echo $row['nama_hemodialisa'] ?></h4>
                                    </a>
                                </li>
                            <?php } ?>
                        </ul>
                    ...
                    <div class="col-lg-7 ml-auto" data-aos="fade-left" data-aos-delay="100">
                        <div class="tab-content">
                            ...
                            $query = mysqli_query(
                                $conn,
                                "SELECT * FROM layanan_hemodialisa"
                            );
                            $i = 0;
                            while ($row = mysqli_fetch_array($query)) {
                            ...
                            ?>
                                <div class="tab-pane <?php echo ($i == 1 ? "active" : "") ?> show" id="tab-<?php echo $i ?>">
                                    <figure>
                                        <img src="hemodialisa/<?php echo $row['file'] ?>" width="600px" height="400px">
                                        <h5><?php echo $row['nama_hemodialisa'] ?></h5><br>
                                        <br>
                                        <div>
