          ...
          <div class="col-lg-10">
            ...
            <form action="layanan_icu_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="nama_icu">
              </div>
              <p>Upload File</p>
              <div class="form-group mt-3">
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  <thead>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM layanan_icu");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $row['nama_icu'] ?></td>
                      <td><img src="icu/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                      <td><?php echo $row['deskripsi'] ?></td>
                      <td>
                        <a href="edit_layanan_icu.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-primary">Edit</a>
                        <a href="layanan_icu_act.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                  </tbody>
                <?php } ?>
