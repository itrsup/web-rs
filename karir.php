...
<header id="header" class="d-flex align-items-center">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="karir/<?php echo $row['file'] ?>" class="img-fluid portfolio-lightbox preview-link" alt="">
            </div>
          <?php } ?>
        </div>
      </div>
  ...
  <div class="text-center icon-box" data-aos="fade-up" data-aos-delay="100">
    <a href="https://mail.google.com/mail/u/0/?view=cm&tf=1&fs=1&to=itrsup29@gmail.com" target="_blank" rel="nofollow noopener" title="Send email with Gmail" class="btn btn-success">Kirim Lamaran</a>
  </div>
  <!-- ======= Footer ======= -->
  <footer id="footer">
