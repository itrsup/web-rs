                ...
                <section id="cta-pricing" class="cta-pricing">
                    <div class="container">
                        <div class="text-center">
                            <h3><strong>HAK PASIEN DAN KELUARGA</strong></h3>
                        </div>
                    </div>
                </section>
                <div class="row  justify-content-center" data-aos="fade-up">
                    <div class="col-lg-10">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            <p>Hal-hal yang menjadi <strong>HAK PASIEN</strong> adalah sbb : </p>
                            <ul>
                                ...
                                <li>Memperoleh layanan yang manusiawi,adil,jujur tanpa deskriminasi. </li>
                                <li>Memperoleh layanan kesehatan yang bermutu sesuai dengan standar profesi dan standar profesional. </li>
                                <li>Memperoleh layanan yang efektif dan efisien sehingga pasien terhindar dari kerugian fisik dan material.</li>
                                ...
                                <li>Meminta konsultasi tentang penyakit yang dideritanya kepada dokter lain yan mempunyai SIP.</li>
                                <li>Mendapatkan privasi dan kerahasiaan penyakit termasuk data-data medisnya. </li>
                                <li>Mendapat informasi yang meliputi diagnosis dan tata cara tindakan medis</li>
                                <li>Memberikan persetujuan atau menolak atas tindakan yang akan di lakukan oleh tenaga kesehatan terhadap penyakit yang di deritanya.</li>
                                <li>Di dampingi keluarganya dalam keadaan kritis</li>
                                <li>Menjalankan ibadah sesuai agama dan kepercayaan yang di anutnya. </li>
                                <li>Memperoleh keamanan dan keselamatan dirinya selama perwatan di RS</li>
                                <li>Mengajukan usul,saran,perbaikan atas perlakuan RS terhadap dirinya.</li>
                                <li>menolak bimbingan rohani yang tidak sesuai dengan agama dan kepercayaan.</li>
                                <li>Menggugat atau menuntut rs diduga memberikan pelayanan yang tidak sesuai dengan standar baik perdata maupun pidana.</li>
                                <li>mengeluh pelayanan RS yang tidak sesuai dengan standar pelayanan melalui media cetak dan elektronik sesuai perundang-undangan.</li>
                            </ul>
                            <p><strong>KEWJIBAN PASIEN :</strong></p>
                            <ul>
                                <li>Mematuhi peraturan yang berlaku di RS.</li>
                                <li>Menggunakan fasilitas RS secara bertanggung jawab</li>
                                <li>Menghormati hak-hak pasien lain dan hak tenaga kesehatan lainya.</li>
                                <li>Memberikan informasi yang jujur, lengkap dan akurat tentang masalah kesehatan.</li>
                                <li>Memberikan informasi mengenai kemampuan finansial dan jaminan kesehatan yang dimilikinya.</li>
                                <li>Mematuhi rencana terapi yang di rekomendasikan oleh tenaga kesehatan di RS</li>
                                <li>Menerima segala konsekwensinya atas keputusan pribadinya untuk menolak rencanya terapi yang direkomendasikan oleh tenaga kesehatan dalam rangka penyembuhan penyakitnya</li>
