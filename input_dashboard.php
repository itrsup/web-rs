    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Dashboard</H4>
            <form action="input_dashboard_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Nama dashboard</p>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="nama_dashboard">
              </div>
              <p>Upload File</p>
              <div class="form-group mt-3">
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $row['dashboard_id'] ?></td>
                        <td><?php echo $row['nama_dashboard'] ?></td>
                        <td><img src="dashboard/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                        <td>
                          <a href="edit_dashboard.php?id=<?php echo $row['dashboard_id'] ?>" class="btn btn-primary">Edit</a>
                          <a href="input_dashboard_act.php?id=<?php echo $row['dashboard_id'] ?>" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
