        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            ...
            <form action="input_dokter_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              ...
              <div class="text-center"><button type="submit" name="insert">simpan</button></div>
              <br>
              <div class="mt-5">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="mapping_spesialis.php?id=<?php echo $row['dokter_id'] ?>" class="btn btn-success">mapping spesialis</a>
                          <a href="input_jadwal_dokter.php?id=<?php echo $row['dokter_id'] ?>" class="btn btn-secondary">Jadwal Dokter</a>
                          <a href="" class="btn btn-primary">Edit</a>
                          <a href="input_dokter_act.php?id=<?php echo $row['dokter_id'] ?>" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
