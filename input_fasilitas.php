        ...
        <section id="contact" class="contact">
            <div class="container">
                <div class="row mt-5 justify-content-center" data-aos="fade-up">
                    <div class="col-lg-10">
                        <H4>Fasilitas</H4>
                        <form action="fasilitas_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
                            <p>Nama Fasilitas</p>
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="nama_fasilitas">
                            </div>
                            <div class="text-center"><button type="submit" name="simpan">upload</button></div>
                            <br>
                            <div class="mt-5">
                                <table id="example" class="display cell-border" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $row['fasilitas_id'] ?></td>
