...
$data = mysqli_query($conn, "SELECT * FROM layanan_kamarbedah WHERE layanan_id = '" . $_GET['id'] . "'");
$kodok = mysqli_fetch_array($data);

$nama = $kodok['nama_kamarbedah'];
$file = $kodok['file'];
                    ...
                    <div class="col-lg-10">
                        ...
                        <form action="layanan_kamarbedah_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="nama_kamarbedah" value="<?php echo $nama ?>">
                            </div>
                            <p>Upload File</p>
                            <div class="form-group mt-3">
                            ...
                            <div class="form-group mt-3">
                                <img src="kamarbedah/<?php echo $file ?>" width="150px" height="100px">
                            </div>
                            <p>Deskripsi</p>
                            <div class="form-group mt-3">
