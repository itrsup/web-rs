    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Brita</H4>
            <form action="brita_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Judul Britanya nih</p>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="nama_brita">
              </div>
              <p>Upload File</p>
              <div class="form-group mt-3">
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      <td><?php echo $row['brita_id'] ?></td>
                      <td><?php echo $row['nama_brita'] ?></td>
                      <td><img src="brita/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
