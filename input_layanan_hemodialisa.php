    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Layanan hemodialisa</H4>
            <form action="layanan_hemodialisa_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Nama layanan</p>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="nama_hemodialisa">
              </div>
              <p>Upload File</p>
              <div class="form-group mt-3">
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  <thead>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM layanan_hemodialisa");
                    while ($row = mysqli_fetch_array($query)) {
                    ?>
                      <tr>
                        <th>id layanan</th>
                        <th>Nama hemodialisa</th>
                        <th>foto</th>
                        <th>deskripsi</th>
                        <th>action</th>
                      </tr>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $row['nama_hemodialisa'] ?></td>
                      <td><img src="hemodialisa/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                      <td><?php echo $row['deskripsi'] ?></td>
                      <td>
                        <a href="edit_layanan_hemodialisa.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-primary">Edit</a>
                        <a href="layanan_hemodialisa_act.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                  </tbody>
                <?php } ?>
