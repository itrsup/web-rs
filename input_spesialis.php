    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <H4>Spesialis</H4>
            <form action="input_spesialis_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              <p>Nama Spesialis</p>
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $row['spesialis_id'] ?></td>
                        <td><?php echo $row['nama_spesialis'] ?></td>
                        <td><a href="input_spesialis_act.php?id=<?php echo $row['spesialis_id'] ?>" class="btn btn-danger">Hapus</a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
