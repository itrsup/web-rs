            ...
            <form action="layanan_rawat_jalan_act.php" method="post" class="php-email-form" enctype="multipart/form-data">
              ...
              <div class="mt-5">
                <table id="example" class="display cell-border" style="width:100%">
                  <thead>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM layanan_rawat_jalan");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><img src="foto2/<?php echo $row['file'] ?>" width="150px" height="100px"></td>
                      <td><?php echo $row['deskripsi'] ?></td>
                      <td>
                        <a href="edit_layanan_rawat_jalan.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-primary">Edit</a>
                        <a href="layanan_rawat_jalan_act.php?id=<?php echo $row['layanan_id'] ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                  </tbody>
                <?php } ?>
